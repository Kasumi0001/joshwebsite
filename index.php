...
<!-- 3 ARTICLES WITH IMAGES -->
    <div class="col-md-4">
        <img class="img-fluid" src="http://170.187.231.66/~mesh20/sub2/wp-content/themes/starter_for_josh_site/images/game.jpg" alt="woman">
    ...
    <div class="col-md-4">
        <img class="img-fluid" src="http://170.187.231.66/~mesh20/sub2/wp-content/themes/starter_for_josh_site/images/game.jpg" alt="robot">
        <h4 class="article-title">A PORTRAIT</h4>
        <p class="date">Friday November 2030</p>
        <p class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.
        </p>
    ...
    <div class="col-md-4">
        <img class="img-fluid" src="http://170.187.231.66/~mesh20/sub2/wp-content/themes/starter_for_josh_site/images/game.jpg" alt="mapping">
        <h4 class="article-title">A PORTRAIT</h4>
        <p class="date">Friday November 2030</p>
        <p class="article-p">STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.
        </p>
